...
class StackingSequence {
    ...
    var layerThicknessText: String {
        didSet {
            ...
            guard let layerThickness = layerThickness else { return }
    ...
    var isValid: Bool {
        get {
            return stackingSequence != nil
        }
    }
    
    var maxNumOfLayers: Int
    var tooManyLayers: Bool = false
    
    init(stackingSequenceText: String, layerThickness: Double, maxNumOfLayers: Int) {
        self.stackingSequenceText = stackingSequenceText
        self.layerThickness = layerThickness
        layerThicknessText = "\(layerThickness)"
        self.maxNumOfLayers = maxNumOfLayers
        stackingSequence = parseStackingSequenceText(stackingSequenceText: stackingSequenceText)
    }
    
    init(sectionTitle: String, stackingSequenceText: String, layerThickness: Double, maxNumOfLayers: Int) {
    ...
    func parseStackingSequenceText(stackingSequenceText: String) -> [Double]? {
        ...
        guard numberOfLayers <= maxNumOfLayers else {
            tooManyLayers = true
            return nil
        }
        tooManyLayers = false
