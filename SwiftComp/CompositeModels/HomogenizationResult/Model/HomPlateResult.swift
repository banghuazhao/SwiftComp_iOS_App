...
class HomPlateResult {
    ...
    private func setInPlanePropertiesArray() {
        ...
        inPlanePropertiesArray = [
            ...
            HomResultProperty(name: "Mutual Influencet η₁₂‚₂", valueText: inPlaneProperties["eta121"] ?? "")
        ]
    }
    ...
    private func setFlexuralPropertiesArray() {
        ...
        flexuralPropertiesArray = [
            ...
            HomResultProperty(name: "Mutual Influencet η₁₂‚₂", valueText: flexuralProperties["eta121"] ?? "")
        ]
    }
