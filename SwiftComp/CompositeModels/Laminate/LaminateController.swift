...
class LaminateController: SwiftCompTemplateViewController, UITextFieldDelegate {
    // Data
...
extension LaminateController: LaminateStackingSequenceDataBaseDelegate {
...
extension LaminateController: LaminateMaterialDataBaseDelegate {
