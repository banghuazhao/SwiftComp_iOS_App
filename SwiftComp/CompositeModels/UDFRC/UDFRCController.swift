...
class UDFRCController: SwiftCompTemplateViewController, UITextFieldDelegate {
    // Data
...
extension UDFRCController: FiberMaterialDataBaseDelegate {
...
extension UDFRCController: MatrixMaterialDataBaseDelegate {
