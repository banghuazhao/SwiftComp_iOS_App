...
class UDFRCControllerOld: SwiftCompTemplateViewController, UITextFieldDelegate {
    // Data
    ...
    override func createLayout() {
        ...
        volumeFractionSlider.widthAnchor.constraint(equalToConstant: 310).isActive = true
        ...
        fiberMaterialTypeSegementedControl.widthAnchor.constraint(equalToConstant: 310).isActive = true
        ...
        matrixMaterialTypeSegementedControl.widthAnchor.constraint(equalToConstant: 310).isActive = true
    ...
    @objc func enterFiberMaterialDataBase(_ sender: UIButton, event: UIEvent) {
        ...
        let navController = SCNavigationController(rootViewController: UDFRCFiberMaterialDataBaseViewController)
    ...
    @objc func changeFiberMaterialType() {
        ...
        createMaterialCard(materialCard: &fiberMaterialCard, materialName: fiberMaterialNameLabel, label: &fiberMaterialPropertiesLabel, value: &fiberMaterialPropertiesTextField, aboveConstraint: fiberMaterialTypeSegementedControl.bottomAnchor, under: fiberMaterialView, typeOfAnalysis: analysisSettings.typeOfAnalysis, materialType: fiberMaterialType)
    ...
    @objc func enterMatrixMaterialDataBase(_ sender: UIButton, event: UIEvent) {
        ...
        let navController = SCNavigationController(rootViewController: UDFRCMatrixMaterialDataBaseViewController)
    ...
    @objc func changeMatrixMaterialType() {
        ...
        createMaterialCard(materialCard: &matrixMaterialCard, materialName: matrixMaterialNameLabel, label: &matrixMaterialPropertiesLabel, value: &matrixMaterialPropertiesTextField, aboveConstraint: matrixMaterialTypeSegementedControl.bottomAnchor, under: matrixMaterialView, typeOfAnalysis: analysisSettings.typeOfAnalysis, materialType: matrixMaterialType)
    ...
    override func createActionSheet() {
        ...
        let m1 = UIAlertAction(title: "Voigt Rules of Mixture", style: UIAlertAction.Style.default) { [weak self] (_) -> Void in
        ...
        let m2 = UIAlertAction(title: "Reuss Rules of Mixture", style: UIAlertAction.Style.default) { [weak self] (_) -> Void in
        ...
        let m3 = UIAlertAction(title: "Hybrid Rules of Mixture", style: UIAlertAction.Style.default) { [weak self] (_) -> Void in
    ...
    func changeTypeOfAnalysis(typeOfAnalysis: TypeOfAnalysis) {
        createMaterialCard(materialCard: &fiberMaterialCard, materialName: fiberMaterialNameLabel, label: &fiberMaterialPropertiesLabel, value: &fiberMaterialPropertiesTextField, aboveConstraint: fiberMaterialTypeSegementedControl.bottomAnchor, under: fiberMaterialView, typeOfAnalysis: typeOfAnalysis, materialType: fiberMaterialType)

        fiberMaterialCard.bottomAnchor.constraint(equalTo: fiberMaterialView.bottomAnchor, constant: -12).isActive = true

        createMaterialCard(materialCard: &matrixMaterialCard, materialName: matrixMaterialNameLabel, label: &matrixMaterialPropertiesLabel, value: &matrixMaterialPropertiesTextField, aboveConstraint: matrixMaterialTypeSegementedControl.bottomAnchor, under: matrixMaterialView, typeOfAnalysis: typeOfAnalysis, materialType: matrixMaterialType)
...
extension UDFRCControllerOld: FiberMaterialDataBaseDelegate {
    func userTypeFiberMaterialDataBase(materialName: String) {
        fiberMaterialNameLabel.text = materialName
...
extension UDFRCControllerOld: MatrixMaterialDataBaseDelegate {
    func userTypeMatrixMaterialDataBase(materialName: String) {
        matrixMaterialNameLabel.text = materialName
