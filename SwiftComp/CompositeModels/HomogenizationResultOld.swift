...
class HomogenizationResultOld: UIViewController {
    ...
    func fetchGmshMeshImage() {
        ...
        let urlStringRaw = "\(Constant.baseURL)/\(route)/meshImage?userDirectory=\(resultData.swiftcompCwd)"
