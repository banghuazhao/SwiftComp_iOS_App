...
protocol LaminateStackingSequenceDataBaseDelegate {
    func userTypeStackingSequenceDataBase(stackingSequence: String)
}

class LaminateStackingSequenceDataBase: UITableViewController {
    ...
    var delegate: LaminateStackingSequenceDataBaseDelegate?
