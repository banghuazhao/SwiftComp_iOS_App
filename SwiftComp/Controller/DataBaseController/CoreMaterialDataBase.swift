...
protocol CoreMaterialDataBaseDelegate: AnyObject {
    func userTypeCoreMaterialDataBase(materialName: String)
}

class CoreMaterialDataBase: UITableViewController {
    
    let predefinedMaterial: [String] = ["Empty Material", "Nomex", "Aluminum", "Steel"]
    
    var userSavedMaterial: [UserCoreMaterial] = []
    
    weak var delegate: CoreMaterialDataBaseDelegate?
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            ...
            do {
                userSavedMaterial = try context.fetch(UserCoreMaterial.fetchRequest())
            }
            catch {
                print(error)
            }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.userTypeCoreMaterialDataBase(materialName: materialName)
