...
class HoneycombSandwich: SwiftCompTemplateViewController, LaminateStackingSequenceDataBaseDelegate, CoreMaterialDataBaseDelegate, LaminateMaterialDataBaseDelegate, UITextFieldDelegate {
    ...
    override func createLayout() {
        ...
        coreGeometryOutlineLayer.strokeColor = UIColor.attributedTextWhiteColor.cgColor
    ...
    func generateCoreGeometryFigure() {
        ...
        coreGeometryFigureLayer.strokeColor = UIColor.attributedTextWhiteColor.cgColor
    ...
    @objc func enterCoreMaterialDataBase(_ sender: UIButton, event: UIEvent) {
        ...
        self.navigationController?.pushViewController(coreMaterialDataBaseViewController, animated: true)
    }
