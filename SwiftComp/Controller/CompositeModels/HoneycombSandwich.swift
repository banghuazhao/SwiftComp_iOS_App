...
class HoneycombSandwich: SwiftCompTemplateViewController, LaminateStackingSequenceDataBaseDelegate, CoreMaterialDataBaseDelegate, LaminateMaterialDataBaseDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.coreLengthTextField.delegate = self
        self.coreThicknessTextField.delegate = self
        self.coreHeightTextField.delegate = self
    ...
    override func createLayout() {
        ...
        coreMaterialTypeSegementedControl.widthAnchor.constraint(equalTo: coreMaterialView.widthAnchor, multiplier: 0.8).isActive = true
    ...
    @objc func enterStackingSequenceDataBase(_ sender: UIButton, event: UIEvent) {
        ...
        let navController = UINavigationController(rootViewController: LaminateStackingSequenceDataBaseViewController)
    ...
    @objc func enterCoreMaterialDataBase(_ sender: UIButton, event: UIEvent) {
        ...
        let navController = UINavigationController(rootViewController: coreMaterialDataBaseViewController)
        
        self.present(navController, animated: true, completion: nil)
    }
    
    func userTypeCoreMaterialDataBase(materialName: String) {
        self.coreMaterialNameLabel.text = materialName
    ...
    @objc func changeCoreMaterialType() {
        ...
        createMaterialCard(materialCard: &self.coreMaterialCard, materialName: self.coreMaterialNameLabel, label: &self.coreMaterialPropertiesLabel, value: &self.coreMaterialPropertiesTextField, aboveConstraint: self.coreMaterialTypeSegementedControl.bottomAnchor, under: self.coreMaterialView, typeOfAnalysis: analysisSettings.typeOfAnalysis, materialType: coreMaterialType)
        
        self.coreMaterialCard.bottomAnchor.constraint(equalTo: self.coreMaterialView.bottomAnchor, constant: -12).isActive = true
        
        self.changeCoreMaterialDataField()
    ...
    @objc func enterlaminaMaterialDataBase(_ sender: UIButton, event: UIEvent) {
        ...
        let navController = UINavigationController(rootViewController: laminateLaminaMaterialDataBaseViewController)
    ...
    @objc func changeLaminaMaterialType() {
        ...
        self.changeLaminaMaterialDataField()
    ...
    func changeTypeOfAnalysis(typeOfAnalysis: TypeOfAnalysis) {
        ...
        createMaterialCard(materialCard: &self.coreMaterialCard, materialName: self.coreMaterialNameLabel, label: &self.coreMaterialPropertiesLabel, value: &self.coreMaterialPropertiesTextField, aboveConstraint: self.coreMaterialTypeSegementedControl.bottomAnchor, under: self.coreMaterialView, typeOfAnalysis: typeOfAnalysis, materialType: coreMaterialType)
        ...
        self.laminaMaterialCard.bottomAnchor.constraint(equalTo: self.laminaMaterialView.bottomAnchor, constant: -12).isActive = true
