...
class HomogenizationResult: UIViewController {
    ...
    func createLayout() {
        ...
        if analysisSettings.calculationMethod == .SwiftComp {
            ...
            if analysisSettings.compositeModelName != .Laminate {
                ...
                gmshMeshImageView.translatesAutoresizingMaskIntoConstraints = false
                gmshMeshImageView.topAnchor.constraint(equalTo: gmshMeshImageCard.topAnchor, constant: 36).isActive = true
                gmshMeshImageView.bottomAnchor.constraint(equalTo: gmshMeshImageCard.bottomAnchor, constant: -12).isActive = true
                gmshMeshImageView.centerXAnchor.constraint(equalTo: gmshMeshImageCard.centerXAnchor).isActive = true
                let imageWidth = UIScreen.main.bounds.width - 48
                gmshMeshImageView.widthAnchor.constraint(equalToConstant: imageWidth).isActive = true
                gmshMeshImageView.heightAnchor.constraint(equalToConstant: imageWidth).isActive = true
    ...
    @objc func showSwiftCompOutput(_ sender: UIButton) {
        ...
        swiftCompHomogenizationCalculationInfoController.swiftCompCalculationInfoValue = self.resultData.swiftcompCalculationInfo
