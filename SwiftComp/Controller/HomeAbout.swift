...
class HomeAbout: UIViewController {
    ...
    deinit {
        print("Home about viewContorller is deinitialized")
    }
    ...
    func editLayout() {
        ...
        swiftcompTitleAttributedString.addAttributes([NSAttributedString.Key.foregroundColor : UIColor.attributedTextWhiteColor, NSAttributedString.Key.backgroundColor : UIColor.whitebackgroundColor], range: NSRange(location: 0, length: swiftcompTitleAttributedString.length))
        ...
        ● Calculate effective beam stiffness matrix for beam model.
        ● Calculate A, B, D matrices, transverse shear stiffness matrix, in-plane properties, and flexural properties for plate model.
        ● Calculate effective solid stiffness matrix and engineering constants for solid model.
        ● Calculate coefficient of thermal expansions (CTEs) for the thermoelastic analysis.
        ● Use Gmsh as mesh generator to generate mesh and image.
        ...
        swiftcompAppAttributedString.addAttributes([NSAttributedString.Key.foregroundColor : UIColor.attributedTextWhiteColor, NSAttributedString.Key.backgroundColor : UIColor.whitebackgroundColor], range: NSRange(location: 0, length: swiftcompAppAttributedString.length))
        ...
        cdmHUBTAttributedString.addAttributes([NSAttributedString.Key.foregroundColor : UIColor.attributedTextWhiteColor, NSAttributedString.Key.backgroundColor : UIColor.whitebackgroundColor], range: NSRange(location: 0, length: cdmHUBTAttributedString.length))
